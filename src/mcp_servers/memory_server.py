...
class MemoryMCPServer:
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "description": {"type": "string", "description": "Human-readable description of the exception"},
            ...
            try:
                if name == "add_exception":
                    ...
                    self.memory_manager.update_exception_usage(
                        exception_id=arguments["exception_id"],
                        success=arguments["success"]
                    )
                    
                    result = {
                        "success": True,
                        "message": f"Updated exception {arguments['exception_id']}"
                    }
    ...
    def add_exception_sync(self, vendor: str, category: str, rule_type: str, description: str, reason: str) -> str:
